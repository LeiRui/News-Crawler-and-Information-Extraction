...
import pickle
with open('task3_step2_out.pkl', 'wb') as outp:
	pickle.dump(datas, outp) # word feature
	pickle.dump(positionE1, outp) # position feature
	pickle.dump(positionE2, outp) # position feature
